...
WordPress SEO plugin to boost your rankings with real-time content analysis, SEO metadata, XML sitemaps, redirections, Local Business SEO, and GDPR-compliant analytics.

== Description ==

<h3>The modern, all-in-one SEO plugin for WordPress built with REACT</h3>
...
✔ <strong>Up to 5 focus keywords per post with per-keyword scoring</strong>
...
✔ <strong>Local Business JSON-LD schema with interactive map</strong>
✔ <strong>GDPR-compliant Google Analytics 4, Google Tag Manager & cookie consent banner</strong>
✔ <strong>Migrate from Yoast SEO, Rank Math & SEOPress in one click</strong>
...
<ul>
	...
	<li><strong>Modern architecture</strong>: Built on React and PHP 8.O with a modular design, SEOPulse is fast, extensible, and developer-friendly.</li>
...
<ul>
	...
	<li><strong>6 Gutenberg blocks</strong> with auto-injected structured data: FAQ (FAQPage schema), HowTo (HowTo schema), Table of Contents (auto-generated), Schema (custom JSON-LD), Review (ratings), Product Grid (WooCommerce)</li>
</ul>
...
<ul>
	...
	<li>Product Grid Gutenberg block with search, filter, and sort</li>
...
<ul>
	<li>Modular architecture with 8 toggleable modules</li>
	...
	<li>Modern PHP 8.1 codebase with PSR-4 autoloading</li>
</ul>
...
The full source code (including all uncompiled JavaScript, TypeScript, and SCSS source files) is publicly available at: https://github.com/wp-seopulse/seopulse-public
...
1. Clone the repository: `git clone https://github.com/wp-seopulse/seopulse-public`
2. Navigate to the plugin directory: `cd seopulse-public`
